...
set -e
set -x
exec > /tmp/debug-updatemonitor_proxy.log 2>&1

# This script updates monitor configuration file adding backend server directions (ip:port)
#
# How it works:
...
csvReporter_cfg=$OPENSHIFT_HOMEDIR/cloudtm/conf/csvReporter.cfg
